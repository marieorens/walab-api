...
<div class="row mt-4 mb-3">
 ...
 <div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-10">
        <form @if(isset($agent)) method="POST" action="{{route('agent_update', $agent->id)}}" @else method="POST" action="{{route('agents.store')}}" @endif enctype="multipart/form-data" class="form-horizontal">
            @csrf
            <div class="card shadow-sm">
                ...
                <div class="card-body px-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select name="role_id" id="role_id" class="form-control rounded-pill focus-ring">
                                ...
                                @foreach($roles as $item)
                                    @if($item->id == 2 || $item->id == 3)
                                        <option value="{{$item->id}}" {{isset($agent) && $agent->role_id == $item->id ? 'selected' : ''}}>
                            ...
                            @endif
                            @if(isset($agent) && $agent->role_id == 2)
                                <small class="text-muted d-block mt-2">
                                    <i class="ri-information-line"></i> Rétrograder en Client pour retirer les privilèges Agent
                                </small>
                            @endif
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-footer text-end">
                    ...
                    <a href="{{isset($agent) ? route('agents.show', $agent->id) : route('home')}}" class="btn btn-secondary btn-sm">
