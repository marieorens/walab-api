                ...
                <div class="row">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        ...
                        <div class="ms-auto input-group rounded p-2 bg-light mb-3" style="width:30%">
                            <input type="text" hidden value="users_agent" id="tablesearch">
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <div class="p-3">
                                    ...
                                    <a href="{{ route('exporter.agent') }}"><i class="mdi mdi-microsoft-excel" style="color: #008000;"></i></a>
                                        <!-- <a href="javascript:;" data-bs-toggle="reload"><i class="ri-refresh-line"></i></a> -->
                                        <a data-bs-toggle="collapse" href="#yearly-sales-collapse" role="button" aria-expanded="false" aria-controls="yearly-sales-collapse"><i class="ri-subtract-line"></i></a>
                                        <a href="#" data-bs-toggle="remove"><i class="ri-close-line"></i></a>
                                    </div>
                                    <h5 class="header-title mb-0">Listes des Agents</h5>
                                    <!-- <a href="{{ route('exporter.agent') }}" class="btn btn-primary">Exporter en Excel</a> -->
                                </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered"> 
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="POST" action="{{route('agent_update', $item->id)}}" enctype="multipart/form-data" class="form-horizontal">
                                                            @csrf
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select name="role_id" id="role_id" class="form-control rounded-pill focus-ring" required>
                                                                            ...
                                                                            @foreach($roles as $item_rol)
                                                                                @if($item_rol->id == 2)
                                                                                    <option value="{{$item_rol->id}}" selected>🎯 Agent</option>
                                                                                @elseif($item_rol->id == 3)
                                                                                    <option value="{{$item_rol->id}}">👤 Client</option>
                                                                                @endif     
                                                                            @endforeach
                                                                        </select>
...
<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered"> 
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form method="POST" action="{{route('agents.store')}}" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
